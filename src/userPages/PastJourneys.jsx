          ...
          <div className="w-full max-w-[1480px]">
            ...
            {...fadeInUp}
             className="flex flex-col px-4 sm:px-10 py-6">
              <div className="flex flex-col w-full gap-4 rounded-xl py-6 bg-white leading-tight">
                <p className="md:text-2xl text-xl font-bold px-6">
                  Past Journeys
                </p>
                  ...
                  {data.map((product) => (
                    ...
                    >
                      <div className="product-image mx-[-10px] sm:mx-3 relative">
                        ...
                        <button className="absolute flex items-center justify-center bg-white text-gray-400 right-4 h-8 w-8 top-4 text-center rounded-full">
                          <FaRegHeart />
                        </button>
                        <img
                          src={product.img}
